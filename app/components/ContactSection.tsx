  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <a href="mailto:jeonhg0@gmail.com" className="flex items-center gap-2 text-lg hover:underline">
          ...
          <a href="https://github.com/gitCarrot" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-lg hover:underline">
          ...
          <a href="https://www.linkedin.com/in/honggun-jeon-ics/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-lg hover:underline">
